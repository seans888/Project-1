...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2017 at 07:20 PM
...
--
-- Table structure for table `lqtwx_assets`
--

CREATE TABLE `lqtwx_assets` (
...
--
-- Dumping data for table `lqtwx_assets`
--

INSERT INTO `lqtwx_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(24, 1, 77, 80, 1, 'com_users', 'com_users', '{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"core.edit.own\":{\"6\":1}}'),
...
(54, 18, 60, 61, 2, 'com_modules.module.91', 'Register Login', '{\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"module.edit.frontend\":[]}'),
(55, 18, 62, 63, 2, 'com_modules.module.16', 'Login Form', '{\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"module.edit.frontend\":[]}');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_associations`
--

CREATE TABLE `lqtwx_associations` (
...
--
-- Table structure for table `lqtwx_banners`
--

CREATE TABLE `lqtwx_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `lqtwx_banner_clients`
--

CREATE TABLE `lqtwx_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `lqtwx_banner_tracks`
--

CREATE TABLE `lqtwx_banner_tracks` (
...
--
-- Table structure for table `lqtwx_categories`
--

CREATE TABLE `lqtwx_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `lqtwx_categories`
--

INSERT INTO `lqtwx_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\",\"foobar\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 36, 1, 11, 12, 1, 'news', 'com_content', 'News', 'news', '', '<p>This is the latest new from us.</p><p>You can edit this description in the Content Category Manager.</p><p>This will show the most recent article. You can easily change it to show more if you wish.</p><p>The module on the left shows a list of older articles.</p>', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 477, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_contact_details`
--

CREATE TABLE `lqtwx_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `lqtwx_content_frontpage`
--

CREATE TABLE `lqtwx_content_frontpage` (
...
--
-- Table structure for table `lqtwx_content_rating`
--

CREATE TABLE `lqtwx_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `lqtwx_content_types`
--

CREATE TABLE `lqtwx_content_types` (
...
--
-- Dumping data for table `lqtwx_content_types`
--

INSERT INTO `lqtwx_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `lqtwx_core_log_searches`
--

CREATE TABLE `lqtwx_core_log_searches` (
...
--
-- Table structure for table `lqtwx_extensions`
--

CREATE TABLE `lqtwx_extensions` (
...
--
-- Dumping data for table `lqtwx_extensions`
--

INSERT INTO `lqtwx_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"61454e6b29fb6759a0e56379747ac357\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1498060472}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `lqtwx_finder_links`
--

CREATE TABLE `lqtwx_finder_links` (
...
--
-- Table structure for table `lqtwx_finder_links_terms0`
--

CREATE TABLE `lqtwx_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_finder_links_terms1`
--

CREATE TABLE `lqtwx_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms2`
--

CREATE TABLE `lqtwx_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms3`
--

CREATE TABLE `lqtwx_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms4`
--

CREATE TABLE `lqtwx_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms5`
--

CREATE TABLE `lqtwx_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms6`
--

CREATE TABLE `lqtwx_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms7`
--

CREATE TABLE `lqtwx_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms8`
--

CREATE TABLE `lqtwx_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_terms9`
--

CREATE TABLE `lqtwx_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termsa`
--

CREATE TABLE `lqtwx_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termsb`
--

CREATE TABLE `lqtwx_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termsc`
--

CREATE TABLE `lqtwx_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termsd`
--

CREATE TABLE `lqtwx_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termse`
--

CREATE TABLE `lqtwx_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_links_termsf`
--

CREATE TABLE `lqtwx_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `lqtwx_finder_taxonomy`
--

CREATE TABLE `lqtwx_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `lqtwx_finder_taxonomy`
--

INSERT INTO `lqtwx_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_finder_taxonomy_map`
--

CREATE TABLE `lqtwx_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_finder_terms`
--

CREATE TABLE `lqtwx_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_finder_terms_common`
--

CREATE TABLE `lqtwx_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `lqtwx_finder_terms_common`
--

INSERT INTO `lqtwx_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `lqtwx_finder_tokens`
--

CREATE TABLE `lqtwx_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `lqtwx_finder_tokens_aggregate`
--

CREATE TABLE `lqtwx_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_finder_types`
--

CREATE TABLE `lqtwx_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_languages`
--

CREATE TABLE `lqtwx_languages` (
...
--
-- Dumping data for table `lqtwx_languages`
--

INSERT INTO `lqtwx_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_menu`
--

CREATE TABLE `lqtwx_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `lqtwx_menu`
--

INSERT INTO `lqtwx_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `lqtwx_menu_types`
--

CREATE TABLE `lqtwx_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `lqtwx_menu_types`
--

INSERT INTO `lqtwx_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_messages`
--

CREATE TABLE `lqtwx_messages` (
...
--
-- Table structure for table `lqtwx_messages_cfg`
--

CREATE TABLE `lqtwx_messages_cfg` (
...
--
-- Table structure for table `lqtwx_modules`
--

CREATE TABLE `lqtwx_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `lqtwx_modules`
--

INSERT INTO `lqtwx_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(16, 55, 'Login Form', '', '', 1, 'position-10', 0, '0000-00-00 00:00:00', '2017-06-21 16:07:22', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '{\"pretext\":\"\",\"posttext\":\"\",\"login\":\"\",\"logout\":\"\",\"greeting\":\"1\",\"name\":\"0\",\"usesecure\":\"0\",\"usetext\":\"0\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*'),
...
(91, 54, 'Register Login', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '2017-06-21 16:01:43', '0000-00-00 00:00:00', 1, 'mod_registerlogin', 1, 0, '{\"view\":\"1\",\"useractivation\":\"1\",\"ajax_registration\":\"1\",\"mail_to_admin\":\"1\",\"sitekey\":\"\",\"secretkey\":\"\",\"enablecap_on_register\":\"0\",\"login\":\"\",\"logout\":\"\",\"tou\":\"1\",\"checkbox\":\"1\",\"articleid\":\"\",\"title\":\"I Agree to the Terms of Use\",\"newwindow\":\"_self\",\"usetext\":\"1\",\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_modules_menu`
--

CREATE TABLE `lqtwx_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `lqtwx_modules_menu`
--

INSERT INTO `lqtwx_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `lqtwx_newsfeeds`
--

CREATE TABLE `lqtwx_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_overrider`
--

CREATE TABLE `lqtwx_overrider` (
...
--
-- Table structure for table `lqtwx_postinstall_messages`
--

CREATE TABLE `lqtwx_postinstall_messages` (
...
--
-- Dumping data for table `lqtwx_postinstall_messages`
--

INSERT INTO `lqtwx_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `lqtwx_redirect_links`
--

CREATE TABLE `lqtwx_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_schemas`
--

CREATE TABLE `lqtwx_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `lqtwx_schemas`
--

INSERT INTO `lqtwx_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_session`
--

CREATE TABLE `lqtwx_session` (
...
--
-- Dumping data for table `lqtwx_session`
--

INSERT INTO `lqtwx_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('3n206r194n7tocib0ffi430ip7', 0, 1, '1498065602', 'joomla|s:980:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_tags`
--

CREATE TABLE `lqtwx_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `lqtwx_tags`
--

INSERT INTO `lqtwx_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 477, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_template_styles`
--

CREATE TABLE `lqtwx_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `lqtwx_template_styles`
--

INSERT INTO `lqtwx_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `lqtwx_ucm_base`
--

CREATE TABLE `lqtwx_ucm_base` (
...
--
-- Table structure for table `lqtwx_ucm_content`
--

CREATE TABLE `lqtwx_ucm_content` (
...
--
-- Table structure for table `lqtwx_ucm_history`
--

CREATE TABLE `lqtwx_ucm_history` (
...
--
-- Table structure for table `lqtwx_updates`
--

CREATE TABLE `lqtwx_updates` (
...
--
-- Table structure for table `lqtwx_update_sites`
--

CREATE TABLE `lqtwx_update_sites` (
...
--
-- Dumping data for table `lqtwx_update_sites`
--

INSERT INTO `lqtwx_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1498060540, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1498060544, ''),
...
(5, 'mod_registerlogin', 'extension', 'https://www.joomdev.com/extensionupdates/mod_registerlogin.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_update_sites_extensions`
--

CREATE TABLE `lqtwx_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `lqtwx_update_sites_extensions`
--

INSERT INTO `lqtwx_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `lqtwx_usergroups`
--

CREATE TABLE `lqtwx_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `lqtwx_usergroups`
--

INSERT INTO `lqtwx_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `lqtwx_users`
--

CREATE TABLE `lqtwx_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `lqtwx_users`
--

INSERT INTO `lqtwx_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(477, 'Super User', 'admin', 'yanaventura27@gmail.com', '$2y$10$WVJC1xCiemJ/nQhR4GyvfuNyb.QoTHJsgUKeHvHReknfDkBGIeXgS', 0, 1, '2017-06-21 15:54:12', '2017-06-21 16:13:20', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_user_keys`
--

CREATE TABLE `lqtwx_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `lqtwx_user_notes`
--

CREATE TABLE `lqtwx_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `lqtwx_user_profiles`
--

CREATE TABLE `lqtwx_user_profiles` (
...
--
-- Table structure for table `lqtwx_user_usergroup_map`
--

CREATE TABLE `lqtwx_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `lqtwx_user_usergroup_map`
--

INSERT INTO `lqtwx_user_usergroup_map` (`user_id`, `group_id`) VALUES
(477, 8);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_utf8_conversion`
--

CREATE TABLE `lqtwx_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `lqtwx_utf8_conversion`
--

INSERT INTO `lqtwx_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `lqtwx_viewlevels`
--

CREATE TABLE `lqtwx_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `lqtwx_viewlevels`
--

INSERT INTO `lqtwx_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
(1, 'userspicephp@gmail.com', 'admin', '$2y$12$1v06jm2KMOXuuo3qP7erTuTIJFOnzhpds1Moa8BadnUUeX0RV3ex.', 'Dan', 'Hoover', 1, 41, 1, 0, 'UserSpice', '', '', '', '', '', '', '', '2016-01-01 00:00:00', '2017-06-07 16:11:53', 1, '322418', '', 0, '', '', '', '', '', '', '', '', '', '', '', '0000-00-00 00:00:00', '1899-11-30 00:00:00', '', 0),
...
--
-- Indexes for table `lqtwx_assets`
--
ALTER TABLE `lqtwx_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_associations`
--
ALTER TABLE `lqtwx_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `lqtwx_banners`
--
ALTER TABLE `lqtwx_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_banner_clients`
--
ALTER TABLE `lqtwx_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `lqtwx_banner_tracks`
--
ALTER TABLE `lqtwx_banner_tracks`
...
--
-- Indexes for table `lqtwx_categories`
--
ALTER TABLE `lqtwx_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_contact_details`
--
ALTER TABLE `lqtwx_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `lqtwx_content`
--
ALTER TABLE `lqtwx_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `lqtwx_contentitem_tag_map`
--
ALTER TABLE `lqtwx_contentitem_tag_map`
...
--
-- Indexes for table `lqtwx_content_frontpage`
--
ALTER TABLE `lqtwx_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `lqtwx_content_rating`
--
ALTER TABLE `lqtwx_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `lqtwx_content_types`
--
ALTER TABLE `lqtwx_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `lqtwx_extensions`
--
ALTER TABLE `lqtwx_extensions`
...
--
-- Indexes for table `lqtwx_finder_filters`
--
ALTER TABLE `lqtwx_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `lqtwx_finder_links`
--
ALTER TABLE `lqtwx_finder_links`
...
--
-- Indexes for table `lqtwx_finder_links_terms0`
--
ALTER TABLE `lqtwx_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms1`
--
ALTER TABLE `lqtwx_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms2`
--
ALTER TABLE `lqtwx_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms3`
--
ALTER TABLE `lqtwx_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms4`
--
ALTER TABLE `lqtwx_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms5`
--
ALTER TABLE `lqtwx_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms6`
--
ALTER TABLE `lqtwx_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms7`
--
ALTER TABLE `lqtwx_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms8`
--
ALTER TABLE `lqtwx_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_terms9`
--
ALTER TABLE `lqtwx_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termsa`
--
ALTER TABLE `lqtwx_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termsb`
--
ALTER TABLE `lqtwx_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termsc`
--
ALTER TABLE `lqtwx_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termsd`
--
ALTER TABLE `lqtwx_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termse`
--
ALTER TABLE `lqtwx_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_links_termsf`
--
ALTER TABLE `lqtwx_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `lqtwx_finder_taxonomy`
--
ALTER TABLE `lqtwx_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_finder_taxonomy_map`
--
ALTER TABLE `lqtwx_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `lqtwx_finder_terms`
--
ALTER TABLE `lqtwx_finder_terms`
...
--
-- Indexes for table `lqtwx_finder_terms_common`
--
ALTER TABLE `lqtwx_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `lqtwx_finder_tokens`
--
ALTER TABLE `lqtwx_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `lqtwx_finder_tokens_aggregate`
--
ALTER TABLE `lqtwx_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `lqtwx_finder_types`
--
ALTER TABLE `lqtwx_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `lqtwx_languages`
--
ALTER TABLE `lqtwx_languages`
...
--
-- Indexes for table `lqtwx_menu`
--
ALTER TABLE `lqtwx_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_menu_types`
--
ALTER TABLE `lqtwx_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `lqtwx_messages`
--
ALTER TABLE `lqtwx_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `lqtwx_messages_cfg`
--
ALTER TABLE `lqtwx_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `lqtwx_modules`
--
ALTER TABLE `lqtwx_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_modules_menu`
--
ALTER TABLE `lqtwx_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `lqtwx_newsfeeds`
--
ALTER TABLE `lqtwx_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `lqtwx_overrider`
--
ALTER TABLE `lqtwx_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lqtwx_postinstall_messages`
--
ALTER TABLE `lqtwx_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `lqtwx_redirect_links`
--
ALTER TABLE `lqtwx_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `lqtwx_schemas`
--
ALTER TABLE `lqtwx_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `lqtwx_session`
--
ALTER TABLE `lqtwx_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `lqtwx_tags`
--
ALTER TABLE `lqtwx_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_template_styles`
--
ALTER TABLE `lqtwx_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `lqtwx_ucm_base`
--
ALTER TABLE `lqtwx_ucm_base`
...
--
-- Indexes for table `lqtwx_ucm_content`
--
ALTER TABLE `lqtwx_ucm_content`
...
--
-- Indexes for table `lqtwx_ucm_history`
--
ALTER TABLE `lqtwx_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `lqtwx_updates`
--
ALTER TABLE `lqtwx_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `lqtwx_update_sites`
--
ALTER TABLE `lqtwx_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `lqtwx_update_sites_extensions`
--
ALTER TABLE `lqtwx_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `lqtwx_usergroups`
--
ALTER TABLE `lqtwx_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_users`
--
ALTER TABLE `lqtwx_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_user_keys`
--
ALTER TABLE `lqtwx_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `lqtwx_user_notes`
--
ALTER TABLE `lqtwx_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `lqtwx_user_profiles`
--
ALTER TABLE `lqtwx_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `lqtwx_user_usergroup_map`
--
ALTER TABLE `lqtwx_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `lqtwx_viewlevels`
--
ALTER TABLE `lqtwx_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `lqtwx_assets`
--
ALTER TABLE `lqtwx_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `lqtwx_banners`
--
ALTER TABLE `lqtwx_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_banner_clients`
--
ALTER TABLE `lqtwx_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_categories`
--
ALTER TABLE `lqtwx_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `lqtwx_contact_details`
--
ALTER TABLE `lqtwx_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lqtwx_content`
--
ALTER TABLE `lqtwx_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `lqtwx_content_types`
--
ALTER TABLE `lqtwx_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `lqtwx_extensions`
--
ALTER TABLE `lqtwx_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10001;
--
-- AUTO_INCREMENT for table `lqtwx_finder_filters`
--
ALTER TABLE `lqtwx_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_finder_links`
--
ALTER TABLE `lqtwx_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_finder_taxonomy`
--
ALTER TABLE `lqtwx_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lqtwx_finder_terms`
--
ALTER TABLE `lqtwx_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_finder_types`
--
ALTER TABLE `lqtwx_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_languages`
--
ALTER TABLE `lqtwx_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lqtwx_menu`
--
ALTER TABLE `lqtwx_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
--
-- AUTO_INCREMENT for table `lqtwx_menu_types`
--
ALTER TABLE `lqtwx_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lqtwx_messages`
--
ALTER TABLE `lqtwx_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_modules`
--
ALTER TABLE `lqtwx_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
--
-- AUTO_INCREMENT for table `lqtwx_newsfeeds`
--
ALTER TABLE `lqtwx_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_overrider`
--
ALTER TABLE `lqtwx_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `lqtwx_postinstall_messages`
--
ALTER TABLE `lqtwx_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `lqtwx_redirect_links`
--
ALTER TABLE `lqtwx_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_tags`
--
ALTER TABLE `lqtwx_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `lqtwx_template_styles`
--
ALTER TABLE `lqtwx_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `lqtwx_ucm_content`
--
ALTER TABLE `lqtwx_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_ucm_history`
--
ALTER TABLE `lqtwx_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_updates`
--
ALTER TABLE `lqtwx_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_update_sites`
--
ALTER TABLE `lqtwx_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `lqtwx_usergroups`
--
ALTER TABLE `lqtwx_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `lqtwx_users`
--
ALTER TABLE `lqtwx_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=478;
--
-- AUTO_INCREMENT for table `lqtwx_user_keys`
--
ALTER TABLE `lqtwx_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_user_notes`
--
ALTER TABLE `lqtwx_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `lqtwx_viewlevels`
--
ALTER TABLE `lqtwx_viewlevels`
